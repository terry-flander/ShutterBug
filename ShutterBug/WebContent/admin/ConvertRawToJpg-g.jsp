...
<html>
  <head>
  <title>Convert RAW to JPG</title>
...
<form name="runReport" id="runReport" action="ConvertRawToJpg-p.jsp" target="hiddenFrame" method="post">
<table>
<tr><td>
  <fieldset>
  <legend>Convert RAW to JPG in JPG Directory</legend>
    <table>
