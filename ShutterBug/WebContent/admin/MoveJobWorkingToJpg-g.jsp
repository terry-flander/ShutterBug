...
<html>
  <head>
  <title>Orders: Move WORKING Orders to JPG</title>
...
<form name="runReport" id="runReport" action="MoveJobWorkingToJpg-p.jsp" target="hiddenFrame" method="post">
<table>
<tr><td>
  <fieldset>
  <legend>Orders: Move WORKING Orders to JPG</legend>
    <table>
