...
<html>
  <head>
  <title>Move JPG Mounts to WORKING Subjects</title>
...
<form name="runReport" id="runReport" action="MoveSubjectJpgToWorking-p.jsp" target="hiddenFrame" method="post">
<table>
<tr><td>
  <fieldset>
  <legend>Move JPG Mounts to WORKING Subjects</legend>
    <table>
