...
<form name="runReport" id="runReport" action="CreateOrders-p.jsp" target="hiddenFrame" method="post">
<table>
<tr><td>
  <fieldset>
  <legend>Create Orders from Job Session Subjects</legend>
    <table>
    <tr><td class="messageBox" colspan="2" id="message"></td></tr>
    <tr><td class="inputField"><input type="checkbox" name="mountOnly"></td><td class="inputLabel">Create Orders for Subjects with 'Mounts' only?</td></tr>
    </table>
  </fieldset>
</td></tr>
<tr><td>
  <input type="button" name="saveButton" value="Create" onclick="process()">&nbsp;
