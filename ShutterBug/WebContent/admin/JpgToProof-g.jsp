...
<html>
  <head>
  <title>Move PROOF to Subjects</title>
...
<form name="runReport" id="runReport" action="JpgToProof-p.jsp" target="hiddenFrame" method="post">
<table>
<tr><td>
  <fieldset>
  <legend>Move PROOF to Subjects</legend>
    <table>
