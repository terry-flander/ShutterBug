...
<html>
  <head>
  <title>Create new Shots from new RAW</title>
...
<form name="runReport" id="runReport" action="ReconcileShots-p.jsp" target="hiddenFrame" method="post">
<table>
<tr><td>
  <fieldset>
  <legend>Create new Shots from new RAW</legend>
    <table>
