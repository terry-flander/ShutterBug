...
<html>
  <head>
  <title>Copy Working Shots to FTP</title>
...
<form name="runReport" id="runReport" action="CopyWorkingToFtp-p.jsp" target="hiddenFrame" method="post">
<table>
<tr><td>
  <fieldset>
  <legend>Copy Working Shots to FTP</legend>
    <table>
...
<tr><td>
  <input type="button" name="saveButton" value="Copy" onclick="process()">&nbsp;
