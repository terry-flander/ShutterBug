...
<html>
  <head>
  <title>Orders: Move JPG to WORKING Orders</title>
...
<form name="runReport" id="runReport" action="MoveJobJpgToWorking-p.jsp" target="hiddenFrame" method="post">
<table>
<tr><td>
  <fieldset>
  <legend>Orders: Move JPG to WORKING Orders</legend>
    <table>
